...
/** one problem with this memory allocator is once memory is allocated, it won't
 *be able to take back this probably won't be a problem in our use case NOTE
 *this is not MT-safe, use it as thread-local allocator
 **/
...
// max mem allocable is MEM_ARENA_SIZE * N_MAX_ARENA ~ 1000 GB - this should be
